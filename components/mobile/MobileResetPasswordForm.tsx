...
const MobileResetPasswordForm = ({ token }: MobileResetPasswordFormProps) => {
  ...
  return (
    <main className="flex h-[calc(100vh-80px)] items-center justify-center overflow-hidden px-4">
      <div className="w-full max-w-md space-y-8 rounded-sm bg-white p-8">
        <div className="space-y-3 text-center">
          ...
          <p className="text-sm text-gray-600">{l.auth.resetPasswordDesc}</p>
        </div>
        ...
        {isSuccess ? (
          <div className="space-y-6 text-center" role="status">
            ...
            <Link
              href="/sign-in"
              className="inline-block w-full rounded bg-blue-500 p-4 text-white transition-colors hover:bg-blue-600"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <button
              ...
              className="w-full rounded bg-blue-500 p-4 text-white transition-colors hover:bg-blue-600 disabled:opacity-50"
            >
