      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="overflow-hidden rounded-2xl border border-border bg-white shadow-sm">
          <div className="px-4 py-5 sm:p-6">
            ...
            <p className="mb-4 text-sm leading-7 text-body-muted">
            ...
            <ul className="list-disc space-y-2 pl-5 text-sm leading-6 text-body-muted marker:text-brand">
        ...
        <div className="mt-6 rounded-2xl border border-border bg-white shadow-sm">
          <div className="px-4 py-5 sm:p-6">
            ...
            <ol className="list-decimal space-y-2 pl-5 text-sm leading-6 text-body-muted marker:font-semibold marker:text-brand">
