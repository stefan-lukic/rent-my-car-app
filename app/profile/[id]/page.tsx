      ...
      <main>
        <section className="bg-ink">
          <div className="mx-auto max-w-5xl px-4 pb-16 pt-6 sm:px-6 md:pb-20 md:pt-8 lg:px-8">
            <Link
              href="/"
              className="inline-flex items-center gap-2 rounded-lg text-sm font-semibold text-border-strong transition hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/70"
            >
            ...
            <div className="mt-10 flex flex-col items-center gap-6 text-center sm:flex-row sm:items-end sm:text-left">
              <div className="relative h-28 w-28 shrink-0 overflow-hidden rounded-2xl border-4 border-white/15 bg-ink-secondary shadow-md md:h-32 md:w-32">
                <Image
              ...
              <div className="w-full min-w-0 flex-1">
                ...
                <p className="mt-2 max-w-xl text-sm leading-6 text-border-strong">
              ...
              <button
                ...
                className="flex w-full shrink-0 cursor-not-allowed items-center justify-center gap-3 rounded-2xl border border-body bg-ink-secondary/80 px-5 py-3.5 text-left opacity-80 sm:w-auto"
              >
                ...
                <span>
                  ...
                  <span
                    ...
                    className="block text-[11px] text-body-faint"
                  >
        ...
        <section className="mx-auto -mt-7 max-w-5xl px-4 pb-12 sm:px-6 lg:px-8">
          <div className="relative rounded-2xl border border-border bg-white p-5 shadow-lg md:p-8">
            <div>
            ...
            <div className="mt-7 grid grid-cols-2 gap-3 lg:grid-cols-4">
              <div className="rounded-2xl border border-border bg-surface p-4">
                ...
                <p className="mt-0.5 text-xs font-semibold text-body-subtle">
                  {renter.ratingCount
              ...
              <div className="rounded-2xl border border-border bg-surface p-4">
                <BadgeCheck
                  className={`h-5 w-5 ${
                    isEmailVerified ? 'text-emerald-600' : 'text-body-faint'
                  }`}
                />
                <p className="mt-3 text-sm font-semibold text-ink sm:text-base">
                ...
                <div className="grid gap-7 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <a
                      ...
                      className="group rounded-2xl border border-border bg-surface p-5 transition hover:border-brand/20 hover:bg-brand-tint/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
                    >
                      <div className="inline-flex rounded-xl bg-brand-tint p-2.5 text-brand">
                        <Mail className="h-5 w-5" />
                      </div>
                      <p className="mt-4 text-xs font-bold uppercase tracking-wider text-body-faint">
                        {l.profile.emailAddress}
                      </p>
                      <p className="mt-1 break-all text-sm font-bold text-ink-secondary group-hover:text-brand/90">
                        {renter.email}
                      </p>
                    </a>
                    ...
                    {renter.contactInfo ? (
                      ...
                      >
                        ...
                        <p className="mt-1 break-words text-sm font-bold text-ink-secondary group-hover:text-brand/90">
                          {renter.contactInfo}
                        </p>
                      </a>
                    ) : (
                      <div className="rounded-2xl border border-border bg-surface p-5">
                        <div className="inline-flex rounded-xl bg-border p-2.5 text-body-subtle">
                          <Phone className="h-5 w-5" />
                        </div>
                        <p className="mt-4 text-xs font-bold uppercase tracking-wider text-body-faint">
                          {l.profile.phoneNumber}
                        </p>
                        <p className="mt-1 text-sm font-semibold text-body-subtle">
